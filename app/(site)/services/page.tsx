...
export const metadata: Metadata = {
  title: "시술 안내",
  description: "멜로브로우의 시술 메뉴와 가격 안내. 모든 시술은 1:1 맞춤 상담 후 진행됩니다.",
};

const SERVICES: [string, string, string | null, string, string, string][] = [
  ["자연눈썹", "Natural", "시그니처", "결을 한 올씩 살린 가장 자연스러운 디자인.", "₩250,000", "약 2시간 · 리터치 포함"],
  ["콤보눈썹", "Combo", null, "자연결 위에 음영을 더해 또렷하게.", "₩290,000", "약 2시간 · 리터치 포함"],
  ["섀도우눈썹", "Shadow", null, "화장한 듯 은은한 그라데이션 눈썹.", "₩270,000", "약 2시간 · 리터치 포함"],
  ["남자눈썹", "Men's", null, "자연스러운 결로 인상을 또렷하게.", "₩260,000", "약 2시간 · 리터치 포함"],
  ["입술 (물광)", "Lip", "인기", "혈색을 더해 화사하고 또렷한 입술로.", "₩350,000", "약 2.5시간 · 리터치 포함"],
  ["리터치", "Retouch", null, "타 샵 시술 후 결을 다시 살리는 보정.", "₩150,000", "약 1.5시간"],
];
    ...
    <div>
      <Section>
        <div style={{ textAlign: "center", maxWidth: 620, margin: "0 auto" }}>
          ...
          >
            모든 시술은 충분한 상담 후 1:1 맞춤으로 진행되며, 첫 시술 후 4~6주 내 1회 리터치가
            포함됩니다.
          </p>
        </div>
